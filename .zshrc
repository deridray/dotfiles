...
# Enable "auto-cd" so you can just type folder names to cd
setopt AUTO_CD
...
# Show time and git info on the prompt
PROMPT='%{$fg[cyan]%}%D{%L:%M:%S} %{$fg[blue]%}%~ %{$fg[green]%}$(git_prompt_info)%{$reset_color%} $ '
